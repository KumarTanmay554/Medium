    ...
    return(
        <div onClick={()=>{
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-2xl cursor-pointer hover:bg-gray-100 transform hover:scale-105 transition-transform duration-500">
                ...
                <div className="p-4">
                  <p className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 capitalize">{prop.authorName}</p>
                  <h3 className="text-lg font-semibold w-[307px] line-clamp-2 hover:text-gray-800 capitalize">{prop.title}</h3>
